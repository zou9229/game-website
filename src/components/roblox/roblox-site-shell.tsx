    ...
    <div className="bg-background text-foreground min-h-screen">
      <header className="border-border/80 bg-background/95 sticky top-0 z-50 border-b backdrop-blur">
        <div className="mx-auto flex min-h-16 max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
          ...
          >
            <Link
              className="text-muted-foreground hover:bg-muted hover:text-foreground rounded-md px-2.5 py-1.5 transition-colors"
              href="/roblox"
            >
              Roblox
            </Link>
            ...
            <Link
              className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-md px-3 py-1.5 font-medium transition-colors"
      ...
      <footer className="border-border/80 bg-muted/20 border-t">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 py-8 text-sm sm:px-6 md:grid-cols-[1.2fr_0.8fr] lg:px-8">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-2xl leading-6">
              ...
              affiliated with Roblox or {featuredGame.developer}.
            </p>
          </div>
