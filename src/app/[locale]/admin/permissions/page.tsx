...
export default function PermissionsPage() {
  ...
  async function handleDelete() {
    ...
    try {
      const res = await fetch(`/api/admin/permissions?id=${deletingPerm.id}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (data.code === 0) {
      ...
      <div className="space-y-4 py-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder={t('permissions.code_placeholder')}
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder={t('permissions.resource_placeholder')}
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder={t('permissions.action_placeholder')}
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder={t('permissions.title_placeholder')}
          />
        </div>
      </div>
    );
