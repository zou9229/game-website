      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="text-muted-foreground mt-4 text-lg leading-8">
            ...
            redemption notes, expired history, and related game guides. We add a
            game only after there is enough source data to avoid thin or copied
            code lists.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Published pages with active, special, and expired code sections.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Entries are separated by source status instead of merged into a
                single unverified list.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card>
